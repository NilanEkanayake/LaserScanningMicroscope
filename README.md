...
7. The STM32G473 has 7 DACS, which is why I chose it, but after some testing, it seems that all of the DACs except the laser can be replaced PWM. This opens the door to using a much cheaper chip.
