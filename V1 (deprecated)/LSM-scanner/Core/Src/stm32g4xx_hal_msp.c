...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    GPIO_InitStruct.Pin = DAC_FINE_Pin|DAC_COARSE_Pin;
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, DAC_FINE_Pin|DAC_COARSE_Pin);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP4_MspInit 0 */
    ...
    PB13     ------> OPAMP4_VINP
    */
    GPIO_InitStruct.Pin = ADC2_BIAS_Pin|ADC2_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PA7     ------> OPAMP1_VINP
    */
    HAL_GPIO_DeInit(GPIOA, ADC1_BIAS_Pin|ADC1_IN_Pin);
  ...
  /* USER CODE END OPAMP4_MspDeInit 0 */
    ...
    PB13     ------> OPAMP4_VINP
    */
    HAL_GPIO_DeInit(GPIOB, ADC2_BIAS_Pin|ADC2_IN_Pin);
