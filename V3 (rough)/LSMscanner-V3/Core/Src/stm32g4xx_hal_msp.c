...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    GPIO_InitStruct.Pin = DAC_Coarse_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DAC_Coarse_GPIO_Port, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    HAL_GPIO_DeInit(DAC_Coarse_GPIO_Port, DAC_Coarse_Pin);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspInit 0 */
    ...
    PA2     ------> OPAMP1_VOUT
    */
    GPIO_InitStruct.Pin = DAC_FINE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DAC_FINE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP2_MspInit 0 */
    ...
    PB0     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = ADC4_BIAS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC4_BIAS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC4_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC4_IN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP3_MspInit 0 */
    ...
    PB13     ------> OPAMP3_VINP
    */
    GPIO_InitStruct.Pin = ADC1_BIAS_Pin|ADC1_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END OPAMP5_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC2_IN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP6_MspInit 0 */
    ...
    PB12     ------> OPAMP6_VINP
    */
    GPIO_InitStruct.Pin = ADC3_BIAS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC3_BIAS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC3_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC3_IN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PA2     ------> OPAMP1_VOUT
    */
    HAL_GPIO_DeInit(DAC_FINE_GPIO_Port, DAC_FINE_Pin);
  ...
  /* USER CODE END OPAMP2_MspDeInit 0 */
    ...
    PB0     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(ADC4_BIAS_GPIO_Port, ADC4_BIAS_Pin);

    HAL_GPIO_DeInit(ADC4_IN_GPIO_Port, ADC4_IN_Pin);
  ...
  /* USER CODE END OPAMP3_MspDeInit 0 */
    ...
    PB13     ------> OPAMP3_VINP
    */
    HAL_GPIO_DeInit(GPIOB, ADC1_BIAS_Pin|ADC1_IN_Pin);
  ...
  /* USER CODE END OPAMP5_MspDeInit 0 */
    ...
    PB14     ------> OPAMP5_VINP
    */
    HAL_GPIO_DeInit(ADC2_IN_GPIO_Port, ADC2_IN_Pin);
  ...
  /* USER CODE END OPAMP6_MspDeInit 0 */
    ...
    PB12     ------> OPAMP6_VINP
    */
    HAL_GPIO_DeInit(ADC3_BIAS_GPIO_Port, ADC3_BIAS_Pin);

    HAL_GPIO_DeInit(ADC3_IN_GPIO_Port, ADC3_IN_Pin);
